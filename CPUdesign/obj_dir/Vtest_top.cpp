...
void Vtest_top::_eval(Vtest_top__Syms* __restrict vlSymsp) {
    ...
    if (((IData)(vlTOPp->clk_i) & (~ (IData)(vlTOPp->__Vclklast__TOP__clk_i)))) {
        ...
        vlSymsp->TOP__test_top__data_ram0._sequent__TOP__test_top__data_ram0__2(vlSymsp);
    ...
    vlSymsp->TOP__test_top__data_ram0._settle__TOP__test_top__data_ram0__1(vlSymsp);
