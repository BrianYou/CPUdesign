...
VL_MODULE(Vtest_top_test_top) {
  public:
    ...
    struct {
        ...
        CData/*5:0*/ __PVT__if_id0__DOT__stall_i;
        CData/*4:0*/ __PVT__id0__DOT__exe_rd_i;
        CData/*0:0*/ __PVT__id0__DOT__pre_inst_is_load_i;
        ...
        CData/*0:0*/ __PVT__exe0__DOT__i_reg_we_o;
