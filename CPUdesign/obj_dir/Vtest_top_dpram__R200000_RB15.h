...
VL_MODULE(Vtest_top_dpram__R200000_RB15) {
  ...
  public:
    static void _sequent__TOP__test_top__data_ram0__2(Vtest_top__Syms* __restrict vlSymsp);
    static void _settle__TOP__test_top__data_ram0__1(Vtest_top__Syms* __restrict vlSymsp);
